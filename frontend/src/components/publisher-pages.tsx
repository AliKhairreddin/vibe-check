...
export function PublisherHomePage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    setMessage(`${completed} creative${completed === 1 ? '' : 's'} submitted. Your advertiser will see the results when processing finishes.`);
