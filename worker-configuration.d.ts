/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 61efaf4fd45b800c65a2429315ff3b58)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	RELEASE_EMAIL_FROM: "releases@adchecked.com";
	API_PUBLIC_URL: "https://api.adchecked.com";
	APP_ADMIN_HOSTS: "admin.adchecked.com";
	APP_ALLOWED_HOSTS: "adchecked.com,www.adchecked.com,app.adchecked.com,admin.adchecked.com,api.adchecked.com,vibe-check.thatcanadian.dev,vibe-check.ali-kheireddin1.workers.dev,localhost,127.0.0.1";
	APP_LEGACY_HOSTS: "vibe-check.thatcanadian.dev";
	APP_PUBLIC_URL: "https://admin.adchecked.com";
	BACKEND_SLOT: "primary-v25";
	CONVEX_URL: "https://energetic-partridge-813.convex.cloud";
	CORS_ALLOWED_ORIGINS: "https://admin.adchecked.com,https://app.adchecked.com";
	GOOGLE_AD_COPY_SHEET_URL: "https://docs.google.com/spreadsheets/d/1p3z7ubxNH8yOh_58CD12XOH6XEN80toI7fvkEgnA29o/edit?usp=drive_link";
	GOOGLE_DRIVE_ADDITIONAL_FOLDERS_JSON: "{\"kissterra\":{\"name\":\"Kissterra Auto\",\"folder_id\":\"1F3rYM_tVmbNXuYkn00HoaopB0UsUVcn5\"},\"kissterra-home\":{\"name\":\"Kissterra Home\",\"folder_id\":\"14JPGzMvru97KOqRIatOscY1lyCKNISIR\"},\"smart-financial\":{\"name\":\"Smart Financial\",\"folder_id\":\"1LozyVky9H1rMjJA4p0em7V8Bm8QnZMM8\"},\"lead-economy\":{\"name\":\"Lead Economy\",\"folder_id\":\"1_aFP9qE59-PmTz9BwM6QyItzWAqEYTSY\"},\"smart-financial-ishan\":{\"name\":\"Smart Financial Ishan\",\"folder_id\":\"1Yc-Qb9jbIjcHbP-0ex7Ez361X_zIIt1j\"}}";
	GOOGLE_DRIVE_FOLDER_ID: "16zD3i1-QnFcrfxXECtjf7T0zbUfzcCAd";
	JOB_DATA_DIR: "/tmp/vibe-check/jobs";
	JOB_MAX_ATTEMPTS: "2";
	JOB_PROCESSING_TIMEOUT_SECONDS: "1800";
	...
	OPENROUTER_VISION_MAX_ATTEMPTS: "2";
	OPENROUTER_VISION_MAX_FRAMES: "12";
	OPENROUTER_VISION_MAX_IMAGE_EDGE: "1024";
	OPENROUTER_VISION_JPEG_QUALITY: "75";
	OPENROUTER_STT_MODEL: "openai/whisper-large-v3";
	OPENROUTER_STT_LANGUAGE: "";
	OPENROUTER_STT_CHUNK_SECONDS: "10";
	OPENROUTER_STT_CHUNK_CONCURRENCY: "3";
	OPENROUTER_STT_MAX_CHUNKS: "30";
	OPENROUTER_STT_WHOLE_AUDIO_MAX_SECONDS: "90";
	REVIEW_BACKEND_SHARDS: "40";
	...
	REVIEW_BACKEND: DurableObjectNamespace<import("./worker/index").ReviewBackend>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "ReviewBackend";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RELEASE_EMAIL_FROM" | "API_PUBLIC_URL" | "APP_ADMIN_HOSTS" | "APP_ALLOWED_HOSTS" | "APP_LEGACY_HOSTS" | "APP_PUBLIC_URL" | "BACKEND_SLOT" | "CONVEX_URL" | "CORS_ALLOWED_ORIGINS" | "GOOGLE_AD_COPY_SHEET_URL" | "GOOGLE_DRIVE_ADDITIONAL_FOLDERS_JSON" | "GOOGLE_DRIVE_FOLDER_ID" | "JOB_DATA_DIR" | "JOB_MAX_ATTEMPTS" | "JOB_PROCESSING_TIMEOUT_SECONDS" | "JOB_WORKER_CONCURRENCY" | "MAX_UPLOAD_MB" | "OPENROUTER_MODEL" | "OPENROUTER_MAX_ATTEMPTS" | "OPENROUTER_RETRY_BASE_SECONDS" | "OPENROUTER_REQUEST_TIMEOUT_SECONDS" | "OPENROUTER_PROVIDER_SORT" | "OPENROUTER_ZDR" | "OPENROUTER_DATA_COLLECTION" | "OPENROUTER_VISION_ENABLED" | "OPENROUTER_VISION_MODEL" | "OPENROUTER_VISION_MAX_ATTEMPTS" | "OPENROUTER_VISION_MAX_FRAMES" | "OPENROUTER_VISION_MAX_IMAGE_EDGE" | "OPENROUTER_VISION_JPEG_QUALITY" | "OPENROUTER_STT_MODEL" | "OPENROUTER_STT_LANGUAGE" | "OPENROUTER_STT_CHUNK_SECONDS" | "OPENROUTER_STT_CHUNK_CONCURRENCY" | "OPENROUTER_STT_MAX_CHUNKS" | "OPENROUTER_STT_WHOLE_AUDIO_MAX_SECONDS" | "REVIEW_BACKEND_SHARDS" | "SESSION_TTL_SECONDS" | "ACP_CLIENT_PASSWORD" | "ADMIN_PASSWORD" | "CLIENT_ADMIN_PASSWORD" | "EMPLOYEE_ADMIN_PASSWORD" | "CONVEX_HTTP_SECRET" | "GOOGLE_DRIVE_SERVICE_ACCOUNT_JSON" | "KISSTERRA_CLIENT_PASSWORD" | "LEAD_ECONOMY_CLIENT_PASSWORD" | "OPENROUTER_API_KEY" | "SESSION_SECRET" | "SMART_FINANCIAL_CLIENT_PASSWORD" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_CHAT_ID">> {}
}
